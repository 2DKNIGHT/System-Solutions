...
namespace WindowsFormsApp10
{
    public class SystemSolution
    {
        ...
        public double[] RungeKuttaMerson(double x, double y, double z1, double z)
        {
            ...
            double[] k2 = InitializeStep(x + (1.0 / 3.0) * k1[1], y + (1.0 / 3.0) * k1[0], z1 + (1.0 / 3.0) * k1[3], z + (1.0 / 3.0) * k1[2], Time + h * (1.0 / 3.0));
            double[] k3 = InitializeStep(x + (1.0 / 6.0) * (k1[1] + k2[1]), y + (1.0 / 6.0) * (k1[0] + k2[0]), z1 + (1.0 / 6.0) * (k1[3] + k2[3]), z + (1.0 / 6.0) * (k1[2] + k2[2]), Time + h * (1.0 / 3.0));
            double[] k4 = InitializeStep(x + (1.0 / 8.0) * (k1[1] + 3.0 * k3[1]), y + (1.0 / 8.0) * (k1[0] + 3.0 * k3[0]), z1 + (1.0 / 8.0) * (k1[3] + 3.0 * k3[3]), z + (1.0 / 8.0) * (k1[2] + 3.0 * k3[2]), Time + h * (1.0 / 2.0));
            double[] k5 = InitializeStep(x + (1.0 / 2.0) * (k1[1] - 3.0 * k3[1] + 4.0 * k4[1]), y + (1.0 / 2.0) * (k1[0] - 3.0 * k3[0] + 4.0 * k4[0]), z1 + (1.0 / 2.0) * (k1[3] - 3.0 * k3[3] + 4.0 * k4[3]), z + (1.0 / 2.0) * (k1[2] - 3.0 * k3[2] + 4.0 * k4[2]), Time + h);
            k7;

            for (int i = 0; i < Solution.Length; i++)
            {
                Solution[i] += (1.0 / 6.0) * (k1[i] + 4.0 * k4[i] + k5[i]);
                EstimateError[i] = (1.0 / 30.0) * (2.0 * k1[i] - 9.0 * k3[i] + 8.0 * k4[i] - k5[i]);
            }
        ...
        {
            if((_score == -1 || _score == 3) && y > x + _eta) return _score = -1;
            ...
            else if(_score == 2) return _score = 3;
            return _score;
        }
